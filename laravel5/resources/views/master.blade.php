        ...
        <div class="container">
            ...
            <div id="navbar" class="collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown active">
                        <a href="#" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> Lainnya <span class="caret"></span>
                        </a>
                         <ul class="dropdown-menu" aria-labelledby="dLabel">
...
<a href="{{ url('logout')}}">Logout</a>
       ...
       <nav class="navbar navbar-default navbar-fixed-bottom">
           <footer class="container">
               ...
               created by <a href="https://www.facebook.com/chakyaja">
               <span><i class="fa fa-facebook" style="color: #1da1f2"></i>Muhammad Akbar</span></a> <!--/   please dont delete this    -->
           </footer>
       </nav>
